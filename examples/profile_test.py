...
# Usage example: testing changes to the spatial profile implementation. This requires ICD version > 17.0. To change the version, check out the appropriate version of the carta-protobuf submodule, and reinstall this module with pip. That will automatically regenerate the protocol buffer code.
